...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__25957){
var vec__25958 = p__25957;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25958,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25958,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__25961_SHARP_){
return (((p1__25961_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__25961_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__25962,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$class], null),sablono.normalize.class$);
} else {
return G__25962;
}
});
...
var len__4736__auto___25965 = arguments.length;
var i__4737__auto___25966 = (0);
while(true){
if((i__4737__auto___25966 < len__4736__auto___25965)){
args__4742__auto__.push((arguments[i__4737__auto___25966]));

var G__25967 = (i__4737__auto___25966 + (1));
i__4737__auto___25966 = G__25967;
continue;
} else {
}
break;
...
var G__25964 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25964,cljs.core.cst$kw$class,cljs.core.vec(classes));
} else {
return G__25964;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq25963){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq25963));
}));
...
var vec__25970 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_((function (){var G__25974 = cljs.core.ffirst(matches);
var fexpr__25973 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__25973.cljs$core$IFn$_invoke$arity$1 ? fexpr__25973.cljs$core$IFn$_invoke$arity$1(G__25974) : fexpr__25973.call(null,G__25974));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25970,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25970,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__25968_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__25968_SHARP_))){
return p1__25968_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__25969_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__25969_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__25976){
var vec__25977 = p__25976;
var seq__25978 = cljs.core.seq(vec__25977);
var first__25979 = cljs.core.first(seq__25978);
var seq__25978__$1 = cljs.core.next(seq__25978);
var tag = first__25979;
var content = seq__25978__$1;
...
var vec__25980 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25980,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25980,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25980,(2),null);
