...
var G__28888 = devtools.prefs.pref(v);
v = G__28888;
continue;
} else {
return v;
...
if(cljs.core.not(devtools.formatters.helpers.pref(cljs.core.cst$kw$disable_DASH_cljs_DASH_fn_DASH_formatting))){
...
}catch (e28891){var _e__28602__auto__ = e28891;
return false;
}})();
...
}catch (e28895){var _e__28602__auto__ = e28895;
return false;
}})();
...
}catch (e28897){var _e__28602__auto__ = e28897;
return false;
}}
}
});
...
var vec__28899 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28899,(0),null);
...
return cljs.core.some((function (p1__28902_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(cljs.core.cst$kw$more_DASH_marker),p1__28902_SHARP_);
}),template);
});
...
var temp__5718__auto__ = devtools.formatters.helpers.pref(((devtools.formatters.helpers.instance_of_a_well_known_type_QMARK_(obj))?cljs.core.cst$kw$min_DASH_expandable_DASH_sequable_DASH_count_DASH_for_DASH_well_DASH_known_DASH_types:cljs.core.cst$kw$min_DASH_expandable_DASH_sequable_DASH_count));
