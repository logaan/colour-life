...
var reader = (function (){var or__4126__auto__ = devtools.prefs.pref(cljs.core.cst$kw$file_DASH_reader);
...
var min_length = (function (){var or__4126__auto__ = devtools.prefs.pref(cljs.core.cst$kw$sanity_DASH_hint_DASH_min_DASH_length);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return (128);
...
var G__31112 = cljs.core.PersistentArrayMap.EMPTY;
var G__31113 = native_stack_trace;
var G__31114 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$ua_DASH_product,cljs.core.cst$kw$chrome], null);
var G__31115 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$asset_DASH_root,""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__31112,G__31113,G__31114,G__31115) : cljs.stacktrace.parse_stacktrace.call(null,G__31112,G__31113,G__31114,G__31115));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31117__$1,cljs.core.cst$kw$file);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31117__$1,cljs.core.cst$kw$line);
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31117__$1,cljs.core.cst$kw$column);
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e31116){var _e = e31116;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___31119 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5718__auto___31119)){
var seen_errors_31120 = temp__5718__auto___31119;
if(cljs.core.truth_(seen_errors_31120.has(self))){
} else {
seen_errors_31120.add(self);

var temp__5720__auto___31121 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5720__auto___31121)){
var sense_31122 = temp__5720__auto___31121;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_31122)].join(''));
} else {
}
}
} else {
