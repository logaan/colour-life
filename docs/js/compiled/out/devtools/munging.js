...
var o28782 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28782["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28783 = temp__5718__auto____$1;
return (o28783["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28595__auto__ = f;
return (o__28595__auto__["toString"]).call(o__28595__auto__);
} else {
return "";
}
}catch (e28784){var _ = e28784;
return "";
}});
...
try{var o__28595__auto___28786 = t;
(o__28595__auto___28786["cljs$lang$ctorPrWriter"]).call(o__28595__auto___28786,t,writer);
}catch (e28785){var __28787 = e28785;
}
...
var char_code = (function (){var o__28595__auto__ = (new String(char$));
return (o__28595__auto__["charCodeAt"]).call(o__28595__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28595__auto__ = String;
return (o__28595__auto__["fromCharCode"]).call(o__28595__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28788 = num_code;
switch (G__28788) {
case (1):
return (185);
...
var o__28595__auto__ = String;
return (o__28595__auto__["fromCharCode"]).call(o__28595__auto__,superscript_code);
});
/**
...
}catch (e28790){var _e__28602__auto__ = e28790;
return false;
}})())){
...
var vec__28791 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28791,(0),null);
...
var or__4126__auto__ = (function (){var temp__5718__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5718__auto__)){
...
if(cljs.core.truth_(temp__5718__auto__)){
var o28794 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28794["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28795 = temp__5718__auto____$1;
return (o28795["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___28802 = arguments.length;
var i__4737__auto___28803 = (0);
while(true){
if((i__4737__auto___28803 < len__4736__auto___28802)){
args__4742__auto__.push((arguments[i__4737__auto___28803]));

var G__28804 = (i__4737__auto___28803 + (1));
i__4737__auto___28803 = G__28804;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28798){
var vec__28799 = p__28798;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28799,(0),null);
...
var G__28805 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28806 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28805;
remaining_tokens = G__28806;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28796){
var G__28797 = cljs.core.first(seq28796);
var seq28796__$1 = cljs.core.next(seq28796);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28797,seq28796__$1);
}));
...
var vec__28810 = cljs.core.split_with((function (p1__28809_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28809_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28810,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28810,(1),null);
...
var vec__28816 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28816,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28816,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28819 = cljs.core.rest(remaining_tokens);
var G__28820 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28819;
name_tokens = G__28820;
continue;
} else {
...
var vec__28823 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28823,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28823,(1),null);
var vec__28826 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28826,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28826,(1),null);
var vec__28829 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28829,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28829,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28829,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28829,(3),null);
...
var vec__28835 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28835,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28835,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28835,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28835,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28835,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28835,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__28839 = temp__5718__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28839,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28839,(1),null);
var vec__28842 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28842,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28842,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28845 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28845) : devtools.munging.parse_fn_info_deep.call(null,G__28845));
})()));
}
} else {
return fn_info;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,cljs.core.cst$kw$devtools$munging_SLASH_result,cljs.core.conj,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(prefix),devtools.munging.make_subscript(subscript)].join('')),prefix,cljs.core.inc);
} else {
...
var G__28846 = (arity + (1));
var G__28847 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28848){
var vec__28849 = p__28848;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28849,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28849,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28852_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28852_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28853_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28853_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28856){
var vec__28857 = p__28856;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28857,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28854){
var G__28855 = cljs.core.first(seq28854);
var seq28854__$1 = cljs.core.next(seq28854);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28855,seq28854__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28865__$1,cljs.core.cst$kw$include_DASH_ns_QMARK_);
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28865__$1,cljs.core.cst$kw$include_DASH_protocol_DASH_ns_QMARK_);
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28865__$1,cljs.core.cst$kw$silence_DASH_common_DASH_protocols_QMARK_);
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28865__$1,cljs.core.cst$kw$ns_DASH_detector);
var vec__28866 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28866,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28866,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28866,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28866,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28866,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28866,(5),null);
...
var o__28595__auto__ = f;
return (o__28595__auto__["getBasis"]).call(o__28595__auto__);
});
/**
...
}catch (e28870){var _e__28602__auto__ = e28870;
...
var G__28871 = (obj[cljs.core.first(path)]);
var G__28872 = cljs.core.rest(path);
obj = G__28871;
path = G__28872;
continue;
} else {
...
var _STAR_ = (function (accum,p__28873){
var vec__28874 = p__28873;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28874,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28874,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28877){
var vec__28878 = p__28877;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28878,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28878,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28878,(2),null);
...
var post_process = (function (p__28882){
var vec__28883 = p__28882;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28883,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28883,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28881_SHARP_){
return (obj[cljs.core.first(p1__28881_SHARP_)]);
}),sorted_matches);
