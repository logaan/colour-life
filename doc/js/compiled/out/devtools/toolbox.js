...
if((typeof devtools !== 'undefined') && (typeof devtools.toolbox !== 'undefined') && (typeof devtools.toolbox.t_devtools$toolbox30946 !== 'undefined')){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox30946 = (function (obj,header,style,tag,meta30947){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
(devtools.toolbox.t_devtools$toolbox30946.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_30948,meta30947__$1){
var self__ = this;
var _30948__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox30946(self__.obj,self__.header,self__.style,self__.tag,meta30947__$1));
}));

(devtools.toolbox.t_devtools$toolbox30946.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_30948){
var self__ = this;
var _30948__$1 = this;
return self__.meta30947;
}));

(devtools.toolbox.t_devtools$toolbox30946.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL);

(devtools.toolbox.t_devtools$toolbox30946.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox30946.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
}));

(devtools.toolbox.t_devtools$toolbox30946.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox30946.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$obj,cljs.core.cst$sym$header,cljs.core.cst$sym$style,cljs.core.cst$sym$tag,cljs.core.cst$sym$meta30947], null);
}));

(devtools.toolbox.t_devtools$toolbox30946.cljs$lang$type = true);

(devtools.toolbox.t_devtools$toolbox30946.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox30946");

(devtools.toolbox.t_devtools$toolbox30946.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"devtools.toolbox/t_devtools$toolbox30946");
}));

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox30946.
 */
devtools.toolbox.__GT_t_devtools$toolbox30946 = (function devtools$toolbox$__GT_t_devtools$toolbox30946(obj__$1,header__$1,style__$1,tag__$1,meta30947){
return (new devtools.toolbox.t_devtools$toolbox30946(obj__$1,header__$1,style__$1,tag__$1,meta30947));
});

}

return (new devtools.toolbox.t_devtools$toolbox30946(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
}));
